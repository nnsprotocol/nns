...
contract NNSControllerV1 is IController, OwnableUpgradeable {
    ...
    function registerWithSignature(
        ...
        _checkValueAndRefundDifference(price);
        _register(to, cldId, name, withReverse, referer, periods, price);
    ...
    function _checkValueAndRefundDifference(uint256 price) internal {
        if (msg.value < price) {
