 ...
 */
contract NNSRegistrarControllerWithReservation is
  ...
  Ownable
{
  ...
  function reserved(string memory name, address sender)
    public
    view
    returns (bool)
  {
  ...
  function _is10k(string memory name) private pure returns (bool) {
    uint256 i;
  ...
  function _computeNamehash(string memory _name)
    private
    pure
