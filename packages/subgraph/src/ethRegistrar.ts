...
import { NameRegistered as ControllerNameRegisteredEvent } from "./types/EthRegistrarController/EthRegistrarController";
import { NameRegistered as NounishClubNameRegisteredEvent } from "./types/NounishClubController/NounishClubController";
...
var rootNode: ByteArray = byteArrayFromHex(
  "739305fdceb24221237c3dea9f36a6fcc8dc81b45730358192886e1510532739"
);
...
export function handleNameRegisteredByNounishClubController(
  event: NounishClubNameRegisteredEvent
): void {
  setNamePreimage(event.params.name, event.params.label, null);
}
