  ...
  return domains.filter(domain => {
    return (
      !domain.name.endsWith(
        '.[e5e14487b78f85faa6e1808e89246cf57dd34831548ff2e6097380d98db2504a].[dec08c9dbbdd0890e300eb5062089b2d4b1c40e3673bbccb5423f7b37dcf9a9c]'
...
function useDomains({ resultsPerPage, domainType, address, sort, page }) {
